...
8. Download the latest Apktool jar file from its official release section: ``curl -LO https://github.com/iBotPeaches/Apktool/releases/download/v3.0.1/apktool_3.0.1.jar``
9. Rename it to "apktool.jar": ``mv apktool_3.0.1.jar apktool.jar``
...
12. Run this: ``jar -xvf ./apktool.jar prebuilt/linux/aapt2``
13. run ``cd prebuilt/linux``
14. Rename it to elf: ``mv aapt2 aapt2_64.elf``
